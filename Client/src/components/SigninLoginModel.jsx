...
const LoginSignupModel = ({ isModelOpen=True, setModelOpen=True }) => {
    ...
    <Transition show={isModelOpen} as={Fragment}>
      <Dialog onClose={() => setModelOpen(false)} className="relative z-50">
        ...
        <div className="fixed inset-0 flex items-center justify-center p-2 sm:p-4 overflow-y-auto">
          ...
          >
            <Dialog.Panel className="relative flex flex-col sm:flex-row bg-white shadow-lg w-full max-w-md sm:max-w-3xl mx-auto rounded-lg">
              <div className="hidden sm:block w-full sm:w-1/2">
                <img
                  src="https://ik.imagekit.io/jezimf2jod/ChatGPT%20Image%20Aug%2028,%202025%20at%2010_15_55%20PM.png"
                  alt="Sports"
